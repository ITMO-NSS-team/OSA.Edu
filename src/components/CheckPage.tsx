...
export function CheckPage(props: Props) {
  ...
  const providerError = selectedModel?.provider === "host"
    ? `${t.host}: ${props.health.host?.detail || t.hostFallback}`
    : t.openrouter;
  ...
  return <section className="page narrow">
    ...
    {!selectedProviderConfigured && <div className="inline-error">{providerError}</div>}
