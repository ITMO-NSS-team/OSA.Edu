...
Будь консервативен: отсутствие слова само по себе не нарушение, если правило смысловое и эквивалентный смысл присутствует. Не подтверждай вывод только потому, что FIRST_PASS_EXPLANATION звучит уверенно.
...
async def verify_semantic_evidence(
    *,
    ...
    return prepared,usage,warnings
