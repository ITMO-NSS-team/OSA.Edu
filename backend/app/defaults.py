...
{'id':'openai/gpt-5.6-luna','label':'GPT-5.6 Luna · production','provider':'openrouter','tier':'production','contextTokens':1_050_000,'note':'Экономичная модель OpenAI для проверки ВКР.'},
]
