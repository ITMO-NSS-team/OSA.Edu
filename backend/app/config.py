...
REPOSITORY_QUALITY_DIR = DATA_DIR / "repository_quality"
REPOSITORY_QUALITY_RUNS_DIR = REPOSITORY_QUALITY_DIR / "runs"
REPOSITORY_QUALITY_JOBS_FILE = REPOSITORY_QUALITY_DIR / "jobs.json"
